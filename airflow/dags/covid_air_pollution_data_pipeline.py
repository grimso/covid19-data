...
dag = DAG('covid_and_air_pollution_data_pipeline',
...
run_quality_checks_final = DataQualityOperator(
    ...
    dag=dag,
    tables_to_check=["air_pollution", "air_stations", "pollutants", "covid_numbers", "counties","county_population"],
)
...
data_api_fetched  >> [stage_air_pollution_to_redshift,stage_air_stations_to_redshift,stage_population_to_redshift,stage_covid_to_redshift] 
stage_air_pollution_to_redshift >> clean_pollution_staging
[clean_pollution_staging,stage_air_stations_to_redshift,stage_population_to_redshift,stage_covid_to_redshift] >> run_quality_checks_staging
run_quality_checks_staging >> [air_pollution_load,air_stations_load,pollutants_load,covid_numbers_load,counties_load,population_load] >> run_quality_checks_final >> end_operator
